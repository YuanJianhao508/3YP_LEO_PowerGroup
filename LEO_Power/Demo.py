...
def basic_simulation(load,solar,storage,duration,rhc):
    LEO = EnergySystem(load,solar,storage,duration)
    [net_profile,load_profile_lis,generation_profile_lis,storage_profile_lis,metric] = LEO.simulate('all_detail',rhc)
...
# SGD
# solar = [{'size':7,'type':'solarPVT'},{'size':6,'type':'solar'},{'size':4.5,'type':'wind'}]
# load = 3500
# storage = [[7.5,34,'local']]
...
duration = 1
#
[net_profile,load_profile_lis,generation_profile_lis,storage_profile_lis,metric] = basic_simulation(load,solar,storage,duration,False)

load_profile = load_profile_lis[0]['profile']['Energy'].to_numpy()
print(max(load_profile))
...
# ax1.set_title("Energy State of Assets over a Year")
#
# # ax1.set_title("Long-term System Performance Under Receding Horizon Control")
# ax1.legend()
# plt.ylim(-2500,5500)
# plt.show()
...
# # ax2.set_title("Energy State of Assets over a Typical Winter Day")
# ax2.set_title("Short-term System Performance Under Basic Rule Control")
# ax2.legend()
# plt.ylim(-3,4)
# plt.show()
...
# np.save('TestData/solar_log3',solar_log)
# np.save('TestData/wind_log3',wind_log)
# sp_log = []
# se_log = []
# for i in sl:
#     sp_log.append(i[0][0])
...
# np.save('TestData/sp_log3',sp_log)
# np.save('TestData/se_log3',se_log)
# res = np.array(log)
# np.save('TestData/log3',res)
#
#
# res = np.load('TestData/log3.npy')
# solar_log = np.load('TestData/solar_log3.npy')
# wind_log = np.load('TestData/wind_log3.npy')
# sp_log = np.load('TestData/sp_log3.npy')
# se_log = np.load('TestData/se_log3.npy')
#
